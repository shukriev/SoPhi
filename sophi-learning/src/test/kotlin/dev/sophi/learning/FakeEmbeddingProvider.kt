 ...
 * higher cosine similarity, and identical texts embed identically. Mirrors
 * sophi-memory's FakeEmbeddingProvider (duplicated, not shared — sophi-learning
 * doesn't and shouldn't depend on sophi-memory for a 12-line test double).
 */

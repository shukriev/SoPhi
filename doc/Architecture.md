...
| `sophi-cli` | Terminal CLI, TUI, slash commands, RPC mode. `sophi skill verify <id>\|--all` runs a trial skill version through the eval suite and reports a human-confirmed promote/revert/manual-review recommendation (ADR-030) | complete |

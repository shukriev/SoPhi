...
class AgentControllerTest : FunSpec({
    ...
    context("createSession") {
        test("returns dto with session id when no title given") {
        ...
        test("passes title to sessionManager") {
    ...
    context("listSessions") {
        ...
        test("maps SessionMeta fields to SessionDto") {
    ...
    context("turn") {
        test("returns 200 with last assistant reply") {
